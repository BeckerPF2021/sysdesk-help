...
@section('title', 'Editar Prioridade de Ticket')
    ...
    <form action="{{ route('ticket-priorities.update', $ticketPriority->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-control form-control-lg" 
                   value="{{ old('name', $ticketPriority->name) }}" required autofocus
                   style="font-size: 1.1rem;"/>
        </div>

        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-warning btn-lg font-weight-bold" style="font-size: 1.1rem;">
                Atualizar
            </button>
