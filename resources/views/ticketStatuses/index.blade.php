                ...
                <div class="py-4 text-white card-body">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 opacity-75 lead">Gerenciamento de status do sistema SYSDESK</p>
                        </div>
                        <div class="col-md-4 text-end">
                            <a href="{{ route('ticket-statuses.create') }}" class="shadow-sm btn btn-light btn-lg">
                                    ...
                                    <tr>
                                        <td colspan="3" class="py-5 text-center">
                                            <div class="text-muted">
                                                <i class="mb-3 opacity-50 fas fa-tags fa-3x"></i>
        ...
        <div class="border-0 shadow modal-content">
            ...
            <div class="py-4 modal-body">
                <div class="text-center">
                    <i class="mb-3 fas fa-tag fa-3x text-danger"></i>
