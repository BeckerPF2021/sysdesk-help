...
<head>
    ...
    <title>Lista de Status de Tickets</title>
            ...
            <tbody>
                @foreach ($ticketStatuses as $status)
                    <tr>
                        ...
                        <td>{{ $status->name }}</td>
                        <td>
                            <a href="{{ route('ticket-statuses.edit', $status->id) }}" class="btn btn-warning">Editar</a>

                            <form action="{{ route('ticket-statuses.destroy', $status->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
